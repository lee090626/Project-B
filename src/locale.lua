...
pair("hud.essence", "Essence {essence}   Lv {level}", "에센스 {essence}   레벨 {level}")
...
pair("nest.summary", "Level {level}   Points {points}   Evolution {evolution}", "레벨 {level}   포인트 {points}   진화 {evolution}")
pair("nest.progress", "Total essence {essence}   Next level {next}", "누적 에센스 {essence}   다음 레벨 {next}")
