...
pair("hud.essence", "Essence {essence}", "에센스 {essence}")
...
pair("help.run_end.summary", "Reason {reason} | Essence {essence} | Matter {matter}", "종료 사유 {reason} | 에센스 {essence} | 물질 {matter}")
...
pair("status.NEED_MATTER", "NEED MATTER", "물질 부족")
...
pair("error.nest.not_enough_matter", "not enough matter", "물질 부족")
...
pair("nest.matter", "Nest Matter: {matter}", "둥지 물질: {matter}")
pair("nest.footer", "Brooder and Hatchery reshape each new run", "부화실과 부화장이 새 런의 흐름을 바꿉니다")
...
pair("run_end.result.nest_matter", "Nest Matter Gained: {matter}", "획득 둥지 물질: {matter}")
