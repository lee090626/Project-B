...
local DESCRIPTORS = {
    ...
    midBonusTime = { key = "bonus.midBonusTime", value = "number" },
    finalBonusTime = { key = "bonus.finalBonusTime", value = "number" },
    bonusTimeCap = { key = "bonus.bonusTimeCap", value = "number" },
    finalWindowMin = { key = "bonus.finalWindowMin", value = "number" },
